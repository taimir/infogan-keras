...
class RNNSharedNet(Network):
    ...
    def __init__(self):
        ...
        self.layers.append(GRU(64, activation="relu"))
...
class RNNBinaryGeneratorNetwork(Network):
    ...
    def __init__(self, image_shape):
        ...
        self.layers.append(TimeDistributed(Reshape(target_shape=(image_shape[0] // 4, image_shape[1] // 4, 64),
                                                   name="g_reshape")))
        ...
        self.layers.append(TimeDistributed(Conv2DTranspose(filters=image_shape[2], kernel_size=(3, 3),
                                                           strides=(2, 2),
                                                           padding='same',
                                                           data_format='channels_last',
                                                           name="g_deconv_3")))
        self.layers.append(TimeDistributed(
            Reshape(target_shape=(1,) + image_shape, name="g_param_reshape")))
